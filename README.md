# SASSDAK
SASSDAK: A Penetration Testing Toolkit :  
SASSDAK is a versatile penetration testing toolkit that provides various options for creating backdoors and exploiting vulnerabilities across different platforms.
